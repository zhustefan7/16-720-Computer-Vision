function fit = affine_ic_d(img, tmplt, p_init, n_iters, verbose, step_size)
...
% $Id: affine_ic_d.m,v 1.1.1.1 2003/08/20 03:07:35 iainm Exp $
...
% 6) Compute diag Hessian and inverse
if step_size
	% Need full Hessian
...
for f=1:n_iters
	...
	% -- Show fitting? --
	if verbose
		disp(['Inverse-Compositional DIAG [',num2str(f-1),']: RMS = ',num2str(fit(f).rms_error)]);
